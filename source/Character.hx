...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bunger':
				tex = Paths.getSparrowAtlas('Bunger','shared',true);
				frames = tex;
				animation.addByPrefix('idle', "BurgerIdle instance 1", 24, false);
				animation.addByPrefix('singUP', 'Up instance 1', 24, false);
				animation.addByPrefix('singDOWN', 'Down instance 1', 24, false);
				if (isPlayer)
				{
					animation.addByPrefix('singLEFT', 'Burger Left instance 1', 24, false);
					animation.addByPrefix('singRIGHT', 'BurgerRight instance 1', 24, false);
				}
				else
				{
					// Need to be flipped! REDO THIS LATER!
					animation.addByPrefix('singLEFT', 'BurgerRight instance 1', 24, false);
					animation.addByPrefix('singRIGHT', 'Burger Left instance 1', 24, false);
				}
